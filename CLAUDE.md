...
4. Connection: `projects/<project>/.xeelo-connection.json` (gitignored) with `xeeloUrl` and GraphQL `token` (optional `userLogin` / `userPwd` for `/ui-test`)
