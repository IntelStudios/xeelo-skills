...
- [ ] **New type-5 subgrid:** also emit `subgrids.<key>.onGrid` (`fields` + `layouts`) like request inbox onGrid — [add-subgrid.md](recipes/add-subgrid.md#ongrid)
