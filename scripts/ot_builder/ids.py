...
CATEGORY_TO_TABLE: dict[str, str] = {
    ...
    "subgridFields": "ObjectSubLine",
    "subgridTemplates": "ObjectSubDefault",
    "subgridDefaultLines": "ObjectSubDefaultLine",
    "subgridOnGrid": "ObjectSubLineOnGrid",
    ...
    "periodics": "Periodic",
    "periodicConditions": "PeriodicCondition",
    "periodicActions": "PeriodicAction",
    "periodicActionParams": "PeriodicActionParam",
    "periodicActionConditions": "PeriodicActionCondition",
    "schedulers": "Scheduler",
    "schedulerLines": "SchedulerLine",
    "schedulerLineParams": "SchedulerLineParam",
    "notifications": "Notification",
    "notificationConditions": "NotificationCondition",
    "notificationAttachments": "NotificationAttachment",
    "workflowStepNotifications": "WorkflowStepNotification",
    "roles": "Role",
